...
import com.user_spring.dto.request.SignInRequest;
import com.user_spring.dto.response.AuthenticationResponse;
import com.user_spring.dto.response.TokenResponse;
...
public class AuthenticationService {
    ...
    String generateToken(User user) throws JOSEException {
        ...
        JWTClaimsSet claimsSet = new JWTClaimsSet.Builder()
                ...
                .issueTime(new Date())
                .expirationTime(
                        new Date(Instant.now().plus(1, ChronoUnit.MINUTES).toEpochMilli())
                )
